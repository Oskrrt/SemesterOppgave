...
public class KeyboardViewController {
    ...
    private void startThread(){
        Thread openKeyboardFilesThread = new Thread(opener);
        opener.setOnSucceeded(this::handleSucceed);
        opener.setOnFailed(this::handleError);
        openKeyboardFilesThread.setDaemon(true);
        toggleGUIDisable();
        openKeyboardFilesThread.start();
    }
    ...
    private void handleError(WorkerStateEvent workerStateEvent) {
        ...
        Label errorPlaceholder = new Label("Could not retrieve saved keyboards, because" + exception);

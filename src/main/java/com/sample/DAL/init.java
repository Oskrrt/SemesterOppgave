...
public class init {
    public static void initFiles(){
        ...
        Monitor m = new Monitor(104.68, "Adaptive Sync Adaptive Sync is a technology that closes the gap between the graphics card's and the monitor's refresh rates, eliminating image tearing and stuttering in the process.","E248W-19203R Ultra Thin", "Sceptre", "66990022", "LED", "24", "1080p", "HDMI");
        Motherboard mb = new Motherboard(135.00, "Powered by 2nd generation AMD Ryzen AM4 and 7th generation Athlon processors to maximize connectivity and speed with dual NVMe M.2, USB 3.1 Gen2, gigabit LAN and up to 64 Gigabytes of DDR4 (3200 Megahertz)", "ROG Strix B450-F Gaming Motherboard", "ASUS", "05990022", "AM4 socket for AMD Ryzen 2nd Generation", "DDR4-3200Mhz", "4", "2 x PCIe 3.0 x16", "1*PCIe 2.0 x4", "(M.2 Heatsink * 2)", "HDMI", "N/A", "SupremeFX S1220A", "ATX");

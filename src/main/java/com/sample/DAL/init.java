...
public class init {
    public static void initFiles(){
        ...
        Monitor m = new Monitor(104.68, "Adaptive Sync Adaptive Sync is a technology that closes the gap between the graphics card's and the monitor's refresh rates, eliminating image tearing and stuttering in the process.","E248W-19203R Ultra Thin", "Sceptre", "66990022", "LED", "24", "1080p", "HDMI / VGA");
        Motherboard mb = new Motherboard(135.00, "Powered by 2nd generation AMD Ryzen AM4 and 7th generation Athlon processors to maximize connectivity and speed with dual NVMe M.2, USB 3.1 Gen2, gigabit LAN and up to 64 Gigabytes of DDR4 (3200 Megahertz)", "ROG Strix B450-F Gaming Motherboard", "ASUS", "05990022", "AM4 socket for AMD Ryzen 2nd Generation", "DDR4-3200Mhz", "4", "2 x PCIe 3.0 x16", "1*PCIe 2.0 x4", "(M.2 Heatsink * 2)", "HDMI 2.0 / DP", "N/A", "SupremeFX S1220A", "ATX");
        Mouse mouse = new Mouse(79.99, "High performance hero 16k sensor: Logitech most accurate sensor yet with upto 16,000 dpi for the ultimate in gaming speed, accuracy and responsiveness across entire dpi range", "G502 SE Hero Hight Performance Gaming Mouse", "Logitech", "04775511", false);
        ...
        GraphicsCard gpu = new GraphicsCard(184.99,"The much anticipated return of MSI iconic dual fan gaming Series.", "Gaming GeForce GTX 1650", "MSI", "67774822", "4GB", "GDRR5");
        RAM ram = new RAM(139.69, "VENGEANCE RGB PRO Series DDR4 overclocked memory lights up your PC with mesmerizing dynamic multi-zone RGB lighting, while delivering the best in DDR4 performance.", "Vengeance RGB PRO", "Corsair", "66667743","16 (2x8)", "3200");
        Speaker sp = new Speaker(58.83, "Versatile setup with speakers that connect easily to computers and other devices via Bluetooth wireless or 3.5mm cable", "Z207 2.0 Multi Device Stereo Speaker", "Logitech", "65777830", "AUX / Bluetooth");

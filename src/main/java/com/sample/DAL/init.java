...
public class init {
    public static void initFiles() throws IOException {
        ...
        Mouse mouse = new Mouse(79.99, "High performance hero 16k sensor: Logitech most accurate sensor yet with upto 16,000 dpi for the ultimate in gaming speed, accuracy and responsiveness across entire dpi range", "G502 SE Hero Performance Mouse", "Logitech", "04775511", false);

...
public class OpenRAM extends OpenAddedComponents implements OpenCorrectFolder {

    public OpenRAM(boolean adminThread) {
        super(adminThread);
    }
    ...
    public List<? extends ComputerComponent> perform() throws IOException, InvalidFileDataException, ValidationException {
        ...
        return ComponentFactory.createRAMsFromFile();
    }
}

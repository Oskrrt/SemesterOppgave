...
public class OpenPowerSupplies extends OpenAddedComponents implements OpenCorrectFolder {

    public OpenPowerSupplies(boolean adminThread) {
        super(adminThread);
    }
    ...
    public List<? extends ComputerComponent> perform() throws IOException, InvalidFileDataException, ValidationException {
        ...
        return ComponentFactory.createPowerSuppliesFromFile();
    }
}

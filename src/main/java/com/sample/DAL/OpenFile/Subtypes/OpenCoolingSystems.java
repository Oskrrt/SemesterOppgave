...
public class OpenCoolingSystems extends OpenAddedComponents implements OpenCorrectFolder {

    public OpenCoolingSystems(boolean adminThread) {
        super(adminThread);
    }
    ...
    public List<? extends ComputerComponent> perform() throws IOException, InvalidFileDataException, ValidationException {
        ...
        return ComponentFactory.createCoolingSystemFromFile();
    }
}
